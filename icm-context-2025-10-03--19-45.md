...
**Script Location**: `/home/wzb/OOR/katas/ICMwRIPER-5/icmwriper-5`
...
**Solution**: `icmwriper-5 generate <project-name>` command
...
**Story creation**: `icmwriper-5 story <story-name>` creates `icm-story-<timestamp>.md`

**Bubble creation**: `icmwriper-5 bubble <bubble-name>` creates `icm-bubble-<timestamp>.md`
...
**Command pattern**: `icmwriper-5 <subcommand> <argument>`
...
The `icmwriper-5` script (119 lines) implements three subcommands with consistent error handling and validation patterns.
...
- The script file is located at `/home/wzb/OOR/katas/ICMwRIPER-5/icmwriper-5`
