...
**Solution**: `icmwriper-5 snb <story-name>` command (SNB = Story aNd Bubble)
...
The `icmwriper-5` script (167 lines) implements four subcommands with consistent error handling and validation patterns.
